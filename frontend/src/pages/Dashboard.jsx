...
const RECOMMENDED = [
  { id: 1, title: 'AI Ethics Seminar', date: 'May 12, 2026', time: '10:00 AM', venue: 'Main Auditorium', category: 'Technology', color: 'bg-blue-500' },
  { id: 2, title: 'Spring Music Fest', date: 'May 15, 2026', time: '05:00 PM', venue: 'Open Ground', category: 'Cultural', color: 'bg-rose-500' },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {RECOMMENDED.map((ev, i) => (
              <div key={ev.id}
                ...
                <h3 className="font-bold text-base text-gray-900 mb-3 group-hover:text-brand-700 transition-colors">{ev.title}</h3>
                ...
                <button className="w-full py-2 bg-brand-50 group-hover:bg-brand-600 group-hover:text-white text-brand-600 text-sm font-semibold rounded-xl transition-all duration-300">
                  View Details
                </button>
              </div>
            ))}
